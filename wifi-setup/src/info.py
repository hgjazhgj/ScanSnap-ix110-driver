...
class InfoMixin:
    ...
    @operation("Read the raw 512-byte chassis EEPROM", mutates=False)
    ...
    @operation("Read the chassis serial number and EEPROM area field", mutates=False)
    ...
    @operation("Read the scanner model name", mutates=False)
    def get_model(self) -> str:
        """Return the actual INQUIRY product name for model-specific operations."""
        return self.get_model_info()["model"]

    @operation("Read device firmware version and raw version records", mutates=False)
    ...
    @operation("Read the hardware Wi-Fi switch state", mutates=False)
    ...
    @operation("Read the device configuration file size", mutates=False)
    ...
    @operation("Read the complete network configuration file and decoded system fields, including secrets", mutates=False)
    ...
    @operation("Read connection password settings and ReadyNotificationPort", mutates=False)
    ...
    @operation("Read basic device network information", mutates=False)
    ...
    @operation("Read extended 802.1X device network information", mutates=False)
    ...
    @operation("Read the device MAC address", mutates=False)
    ...
    @operation("Read the scanner network name", mutates=False)
    ...
    @operation("Read router SSID, authentication and encryption settings", mutates=False)
    ...
    @operation("Read DHCP, IPv4, subnet mask and gateway settings", mutates=False)
    ...
    @operation("Read the current wireless connection status", mutates=False)
    ...
    @operation("Read the current Wi-Fi profile number", mutates=False)
    ...
    @operation("Search for nearby wireless networks using the scanner", mutates=False)
    ...
    @operation("Search for wireless networks including 802.1X information using the scanner", mutates=False)
